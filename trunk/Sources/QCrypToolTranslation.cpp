...
namespace QCrypTool {
    ...
    const char *I18N_CRYPTOOL_MAINWINDOW_MENUHELPACTIONABOUTCRYPTOOL = QT_TRANSLATE_NOOP("I18N_CRYPTOOL_MAINWINDOW_MENUHELPACTIONABOUTCRYPTOOL", "I18N_CRYPTOOL_MAINWINDOW_MENUHELPACTIONABOUTCRYPTOOL");
