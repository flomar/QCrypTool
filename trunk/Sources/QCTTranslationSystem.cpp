...
namespace QCT {
    ...
    const char *I18N_QCRYPTOOL_MAINWINDOW_MENUFILEACTIONOPEN = QT_TRANSLATE_NOOP("I18N_QCRYPTOOL_MAINWINDOW_MENUFILEACTIONOPEN", "I18N_QCRYPTOOL_MAINWINDOW_MENUFILEACTIONOPEN");
